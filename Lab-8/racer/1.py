...
class Player:
    def __init__(self, x_pos, y_pos):
        self.x = x_pos
        self.y = y_pos
        self.im = pygame.image.load("Lab-8/PygameTutorial_3_0/Player.png")
...
class Enemy:
    def __init__(self, x_pos , y_pos, speed):
        self.im = pygame.image.load("Lab-8/PygameTutorial_3_0/Enemy.png")
        self.x = x_pos
        self.y = y_pos
        self.speed = speed
...
class Coins:
    def __init__(self, x_pos , y_pos, speed):
        self.im = pygame.image.load("Lab-8/racer/dollar.png")
...
font = pygame.font.Font("Lab-8/font/Pixeltype.ttf", 50)
...
bg = pygame.image.load("Lab-8/PygameTutorial_3_0/AnimatedStreet.png")
bg = pygame.transform.scale(bg, (cell_size * cell_number, cell_number * cell_size))
bg_rect = bg.get_rect(topleft = (0, 0))

# Background music
musics = [
    "Lab-8/PygameTutorial_3_0/background.wav",
    "Lab-8/PygameTutorial_3_0/crash.wav"
]
...
while not done:
    ...
    if car.colliderect(coin):
        coin_sound =  pygame.mixer.Sound("Lab-8/racer/coins-135571.mp3")
        coin_sound.play()
        coin_score += 1 
        coin_pos_x = random.randint(100, 500) 
        coin_pos_y = -1
